...
public class UbigeoFactory {
    ...
    private static HashMap<String, HashMap<String, HashMap<String, List<String>>>> megaCache = new HashMap<String, HashMap<String, HashMap<String, List<String>>>>();
    private static HashMap<String, UbigeoFlyweight> ubigeos = new HashMap<String, UbigeoFlyweight>();
            ...
            try {
                while(cursor.hasNext()) {
                    ...
                    if (megaCache.get(codDep) == null){
                        HashMap m = new HashMap<String, HashMap<String, HashMap<String, List<String>>>>();
                        megaCache.put(codDep, m);
                    }
                    if (megaCache.get(codDep).get(codProv) == null){

                        HashMap m = new HashMap<String, HashMap<String, List<String>>>();
                        megaCache.get(codDep).put(codProv, m);
                    }
